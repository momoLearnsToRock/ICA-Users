...
const departmentsTbl = new h.SQLTable({ tableName: 'Departments', fields: departmentaFields, autoGeneratedPrimeryKey: true });
...
const usersTbl = new h.SQLTable({ tableName: 'Users', fields: usersFields, autoGeneratedPrimeryKey: false });
const rolesFields = [new h.Field('Id', 'bigInt'), new h.Field('Name', 'string'), new h.Field('ModifiedOn', 'datetime')];
const rolesTbl = new h.SQLTable({ tableName: 'Roles', fields: rolesFields, autoGeneratedPrimeryKey: true });
